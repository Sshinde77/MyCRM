class CareerEnquiryModel {
  ...
  factory CareerEnquiryModel.fromJson(Map<String, dynamic> json) {
    return CareerEnquiryModel(
      ...
      applicantType: _firstString(json, const ['applicant_type', 'applicantType', 'type']),
      ...
      noticePeriod: _firstString(json, const ['notice_period']),
      referenceName: _firstString(json, const ['refrence_name', 'reference_name']),
      createdAt: _firstString(json, const ['created_at', 'createdAt']),
      sourceLabel: _firstString(json, const ['source', 'source_label']),
