  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.leads:
        return MaterialPageRoute(builder: (_) => const Scaffold(body: Center(child: Text('Leads'))));
      case AppRoutes.projects:
        return MaterialPageRoute(builder: (_) => const Scaffold(body: Center(child: Text('Projects'))));
