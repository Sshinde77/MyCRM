...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: const [
          Expanded(child: _NavItem(icon: Icons.home_outlined, label: 'Home')),
          Expanded(child: _NavItem(icon: Icons.business_center, label: 'Services', selected: true)),
          Expanded(child: _NavItem(icon: Icons.groups_2_outlined, label: 'Clients')),
          Expanded(child: _NavItem(icon: Icons.settings_outlined, label: 'Settings')),
        ],
      ),
    );
  }
